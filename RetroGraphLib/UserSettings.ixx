...
#include <fstream> // Cannot be imported.
...
public:
    ...
    static inline const std::string iniPath{ getExePath() + R"(\..\..\resources\config.ini)" };
    static inline const std::string fallbackIniPath{ getExePath() + R"(\..\..\resources\default_config.ini)" };
